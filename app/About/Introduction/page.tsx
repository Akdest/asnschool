    ...
    <>
      ...
      <main className="bg-white">
        ...
        <section className="relative w-full py-32 overflow-hidden">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              <p className="tracking-[0.35em] text-sm font-semibold text-neutral-500 uppercase">
                Who We Are
              </p>
              <h2 className="mt-6 text-5xl sm:text-6xl font-extrabold text-black leading-tight">
            ...
            <div className="relative w-full h-[520px]">
              <Image
                src="/images/intro-classroom.jpg"
        ...
        <section className="relative w-full py-32 bg-neutral-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative w-full h-[520px] order-last lg:order-first">
              <Image
                src="/images/intro-students.jpg"
        ...
        <section className="relative w-full py-32 text-center">
          <blockquote className="max-w-5xl mx-auto text-4xl sm:text-5xl font-extrabold text-black leading-snug">
            Education is not about filling minds — it is about awakening them.
          </blockquote>
          <p className="mt-8 max-w-3xl mx-auto text-lg text-neutral-700 leading-relaxed">
        ...
        {/* SECTION 4 — VISION & MISSION (Creative Modern Layout) */}
        <section className="relative w-full py-32 bg-white">
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            
            {/* Vision */}
            <div className="flex flex-col justify-start">
              <h3 className="text-5xl font-extrabold text-black leading-tight mb-6">
                Our Vision
              </h3>
              <p className="text-lg text-neutral-700 leading-relaxed">
                To nurture responsible, innovative, and compassionate individuals who are equipped to thrive academically and socially in a rapidly changing world.  
                Our vision emphasizes holistic development, empowering students to embrace challenges, think critically, and become proactive contributors to society.  
                We aim to create an environment where every child feels valued, inspired, and prepared to make a positive impact.
              </p>
            </div>

            {/* Mission */}
            <div className="flex flex-col justify-start bg-neutral-50 p-12">
              <h3 className="text-5xl font-extrabold text-black leading-tight mb-6">
                Our Mission
              </h3>
              <p className="text-lg text-neutral-700 leading-relaxed">
        ...
        <section className="relative w-full h-[480px] mt-32">
          <Image
          ...
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
            <h2 className="text-5xl sm:text-6xl font-extrabold text-white text-center leading-tight max-w-4xl px-6">
